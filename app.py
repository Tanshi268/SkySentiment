...
st.markdown("Welcome to SkySentiment, your premier destination for gaining valuable insights into the sentiment surrounding US airlines! In a world where social media plays a pivotal role in shaping public opinion, our web application leverages cutting-edge sentiment analysis techniques to provide you with a comprehensive overview of how people feel about various US airline services.✈️")
